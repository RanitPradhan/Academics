...
player_info = [
        [sg.Text('Desktop Music Player : DBMS Project',
...
STATISTICS_PATH = 'Images/stats4.png'
...
main = [
    ...
    [sg.Image(filename=STATISTICS_PATH, enable_events=True,
                 size=(150,60), pad=(10, 0), key='stats', background_color='black')],
    [sg.Column(layout=currently_playing, justification='c',
               element_justification='c', background_color='black', pad=None)]


]
window = sg.Window('ELCfy', layout=main, size=(
